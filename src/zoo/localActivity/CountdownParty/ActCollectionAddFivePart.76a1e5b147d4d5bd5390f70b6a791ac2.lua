local ActCollectionAddFivePart = class(BaseUI)



function ActCollectionAddFivePart:init(ui, actCollectionNum)
	BaseUI.init(self, ui)
...
function ActCollectionAddFivePart:create(ui, actCollectionNum)
	local addFivePart = ActCollectionAddFivePart.new()
	addFivePart:init(ui, actCollectionNum)
	return addFivePart
end

return ActCollectionAddFivePart