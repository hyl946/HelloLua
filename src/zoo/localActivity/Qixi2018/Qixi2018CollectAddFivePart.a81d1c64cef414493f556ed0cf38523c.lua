local Qixi2018CollectAddFivePart = class(BaseUI)



function Qixi2018CollectAddFivePart:init(ui, actCollectionNum)
	BaseUI.init(self, ui)
...
function Qixi2018CollectAddFivePart:create(ui, actCollectionNum)
	local addFivePart = Qixi2018CollectAddFivePart.new()
	addFivePart:init(ui, actCollectionNum)
	return addFivePart
end

return Qixi2018CollectAddFivePart