...
local RankRaceGetRewardPanel = class(BasePanel)

function RankRaceGetRewardPanel:create(rewardItem, done)
    ...
    local panel = RankRaceGetRewardPanel.new()
    panel:init(rewardItem, done)
    return panel
end

function RankRaceGetRewardPanel:init(rewardItem, done)
    local ui = UIHelper:createUI('ui/RankRace/GetReward.json', 'rank.race.get.reward/panel')
    ...
    self.btn:setString(localize('确 定'))
...
function RankRaceGetRewardPanel:popoutShowTransition( ... )
    local layoutUtils =  require 'zoo.panel.happyCoinShop.utils'
...
function RankRaceGetRewardPanel:_close()
...
function RankRaceGetRewardPanel:popout(callback)
...
function RankRaceGetRewardPanel:onCloseBtnTapped( ... )
    self.closeBtn:dispatchEvent(DisplayEvent.new(DisplayEvents.kTouchTap))
end

return RankRaceGetRewardPanel
